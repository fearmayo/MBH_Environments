...
if __name__ == "__main__":
    ...
    filename = "/Users/rothj1/Desktop/Kelly_Research/MBHEnvironments/MBH_Environments/Romulus25/MBH_Environment_Catalog_Romulus25.hdf5"  # change to your actual file name
